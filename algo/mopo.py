...
class MOPO:
    ...
    def learn_policy(self):
        ...
        fake_data = {
            "observations": torch.concatenate([real_batch["observations"], fake_batch["observations"]], axis=0),
            "actions": torch.concatenate([real_batch["actions"], fake_batch["actions"]], axis=0),
            "next_observations": torch.concatenate([real_batch["next_observations"], fake_batch["next_observations"]],
                                                axis=0),
            "terminals": torch.concatenate([real_batch["terminals"], fake_batch["terminals"]], axis=0),
            "rewards": torch.concatenate([real_batch["rewards"], fake_batch["rewards"]], axis=0)
        }
        data = {
